...
public class EsSearchService extends AbstractCochingApiService {
	 ...
	 * @throws JsonProcessingException
	 */
	public void searchTextForRawsRandom(HttpServletResponse res, EsSearchDTO param) throws JsonProcessingException {
		//String apiUrl = getEsApiUrl("/api/es/search/raws/text.api");
		String apiUrl = getEsApiUrl("/api/v2/es/search/raws/random.api");
