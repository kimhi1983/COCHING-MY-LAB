    ...
    <div class="inner">
      <div class="container">
        <div class="content-wrap">
          ...
          <div :class="['section-content', { 'including': hasBanner }]">
            <!--real-content-->
            <div class="real-content">

              <div 
                v-show="searchResults.ingredient.pi.totalCount <= 0"
                ...
                <div class="link-box-sticky">
                  ...
                  <div class="link-box-wrap sm scroller-x t-scroll-hidden">                    
                    <button v-for="(item, idx) of ingd.ingdList" :key="idx"
                      ...
                      :class="{'active' : (ingd.focusIngd.id == item.id)}"
              ...
              <div class="main-content">
                <div v-show="searchResults.ingredient.pi.totalCount > 0"
                  ...
                  <div class="title-wrap">
                    <div class="title">사용 원료</div>
                    <button
                      @click="onClickGotoRaw(ingd.focusIngd)"
                      type="button" class="btn-go">사용원료 바로가기</button>
                  </div>
...
import { getSearchIngredient, getSearchIngredients, getSearchProd,  getSearchRawList } from '@/api/coching/search/search';
    ...
    async loadIngredient(pIngdId){
      ...
      try{
        ...
        if(fIngd){
          ...
          _vm.ingd.focusIngd.ingdDetail = fIngd.ingdDetail 
            = _vm.convertKeysToCamelCase(dataList[0]);
        }
