<template>
  <!--section-->
  <section id="coching-board-notice">
...
export default {
	...
	data() {
		return {
			boardMstId : BOARD_ID.WEEKLYNEWS_KO,
	...
	methods: {
		...
		async fetchData() {      
			...
			_vm.loading(true);
			try {
				_vm.boardMstId = _vm.getBoardId_weeklyNews();
			} catch (err) {
