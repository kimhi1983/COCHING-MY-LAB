...
export default {
  ...
  data(){
    ...
    const DEF_MYPAGE_MENU = [
      {codeName: _vm.$tt('test001') || '알림함', router: 'coching-mypage-notification'},
      {codeName: _vm.$tt('test001') || '원료자료요청', router: 'coching-mypage-requestRaw'},
      {codeName: _vm.$tt('test001') || '쪽지함', router: 'coching-mypage-message'},
    ];
