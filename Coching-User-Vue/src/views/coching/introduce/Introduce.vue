        ...
        <div>
          <div class="tabs style-box">
            <div class="tabs-nav">
              <ul>
                <li class="active">
                  <a href="javascript:;">코칭 소개</a>
                </li>
                <li>
                  <a @click="onClickTabMenu('user')" href="javascript:;">사용자 메뉴얼</a>
                </li>
                <li>
                  <a @click="onClickTabMenu('partner')" href="javascript:;">파트너 메뉴얼</a>
                </li>
              </ul>
            </div>
            <!--컨텐츠-->
              ...
              <div class="tabs-panel active">
                ...
                <div class="responsive-table check-table">
                  <!-- <PdfImageViewer class="contents-pdf"
                    :key="`introduce_${version}`"
                    :pdfUrl="`/pdf/coching_introduce.pdf?v=${version}`"
                  /> -->
...
export default {
    ...
    onClickDownFile(){
      const _vm = this;
      // const pdfUrl = `/pdf/coching_introduce.pdf?v=${_vm.version}`;
      // const link = document.createElement('a');
      // link.href = pdfUrl;
      // link.download = "Coching 소개";
      // link.click();
    ...
    onImageError(event) {
      ...
      targetObj.style.height = '100px'; // 원하는 높이 설정
		...
		async fetchData() {
			...
			try {
        const params = {
          introType : "1" // 1:코칭 소개, 2:사용자 메뉴얼, 3:파트너 메뉴얼
        };
