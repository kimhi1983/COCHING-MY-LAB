          ...
          <div class="modal-content">
            ...
            <template v-if="localData.contentHtml == ''">
              <div class="modal-body only">
                <div v-if="localData.icon != ''" :class="localData.icon != '' ? localData.icon : ''" class="ic-modal"></div>
            ...
            <template v-if="localData.contentHtml != ''">
              <div v-if="localData.icon == ''" class="modal-header" :class="{'text-center':localData.alignCenter}">
              ...
              <div class="modal-body" 
                ...
                <div v-if="localData.icon != ''" :class="localData.icon != '' ? localData.icon : ''" class="ic-modal"></div>
                <p v-html="localData.contentHtml" class="text-gray"></p>
              </div>
            </template>
