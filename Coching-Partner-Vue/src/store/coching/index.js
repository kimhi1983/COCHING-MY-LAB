...
export default {
  ...
  getters: {
    ...
    userBaseUrlData: state => state.userBaseUrlData,
  ...
  mutations: {
    ...
    SET_USER_BASE_URL_DATA : (state, value) => {
      state.userBaseUrlData = value;
    },
  ...
  actions: {
    ...
    setUserBaseUrlData( {commit}, userBaseUrlData) {     
      localStorage.setItem(appConfig.storageUserBaseUrl, JSON.stringify(userBaseUrlData)); 
      commit('SET_USER_BASE_URL_DATA', userBaseUrlData);
    },

    setNavShow( {commit}, value) {
      commit('SET_NAV_SHOW', value);
    },  
  },
}
