  ...
  <div>
    ...
    <div v-if='pageType == "read"' class="file-wrap">
      <div class="total-wrap">
        ...
        <a href="javascript:;" class="btn-save" @click="onClickAllFileDownload()">모두저장</a>
      </div>
...
export default {
  ...
  methods : {
    ...
    /* 첨부파일 다운로드 */
    // 모두저장
    onClickAllFileDownload() {
      const _vm = this;
      _vm.fileData.filelist.forEach((file) => {
        _vm.onClickFileDownload(file);
      })
    },
