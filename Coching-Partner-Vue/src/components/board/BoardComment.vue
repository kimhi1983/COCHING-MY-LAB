      ...
      <div v-for="(item, idx) of cmtData" 
        ...
        <div class="inner">
          <div v-if="!item.isEditMode">
            <div class="header">
              <div class="left">
                <div class="user">{{item.regName}}</div>
                <div class="date">{{item.rgtDttm | fmtBoardDate}}</div>
                <div class="writer" v-if="item.rgtr === boardWriterSeq">작성자</div>
              </div>
          ...
          <div v-for="(reply, idx) of item.children"
            ...
            <div class="inner">
              <div v-if="!reply.isEditMode">
                <div class="header">
                  <div class="left">
                    <div class="user">{{reply.regName}}</div>
                    <div class="date">{{reply.rgtDttm | fmtBoardDate}}</div>
                    <div class="writer" v-if="reply.rgtr === boardWriterSeq">작성자</div>
                  </div>
...
import { getBoardCmt } from '@/api/coching/comm/board';
