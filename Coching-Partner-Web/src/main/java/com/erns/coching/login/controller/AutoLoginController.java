...
public class AutoLoginController extends BaseLoginController {
	...
	private static final String REDIRECT_PARTNER_AUTO_LOGIN_URL = "redirect:/coching-pn/autoLogin";
	...
	public String login(HttpServletRequest request, HttpServletResponse response,
		...
		try {
			...
			if(dbRt == null) {
				...
				return REDIRECT_PARTNER_AUTO_LOGIN_URL;
			}
			...
			if(jwtConfig.isNeedNewRefreshJwToken(rClaims)){
				...
				AclTokenVO jwtNewRefreshToken = jwtConfig.createRefreshToken(luObj, userRoles, false);
			...
			Map<String, Object> retLogin = doLogin(luObj, partnerRoles, false);
