          ...
          <b-row>
            <b-col cols="12" class="mt-2">
              ...
              >
                ...
                >
                  <b-form-input
                    id="banner-bannerName"
                    placeholder="배너이름을 입력하세요."
            ...
            <b-col cols="12">
              <b-form-group
                label="배너설명"
                label-for="banner-bannerDesc"
              >
                <b-form-textarea
                  rows="5"
                  id="banner-bannerDesc"
                  placeholder="배너설명을 입력하세요."
...
import { BANNER_MODE, DEF_BANNER_INF } from '@/constants/banner';
...
export default {
	name: 'coching-banner-basic-write',
  ...
  beforeDestroy(){
	...
	data() {
		return {
      detail : {...DEF_BANNER_INF, bannerMstCd : this.bannerMstCd,},
