  ...
  <!-- 검색조건 -->
      ...
      <b-card-body class="cm-notice-filter">
        <b-row>
          <b-col v-show="boardMst.cateCd"
            ...
            <b-form-group label="카테고리" label-for="board-basic-category">
              <v-select
                id="board-basic-category"
          ...
          <b-col cols="12" 
            :md='boardMst.cateCd ? "6" : "9"' class="mb-md-0">
            <b-form-group label="검색 키워드" label-for="board-basic-search-keyword">
              <b-input-group>
                <b-form-input 
                  id="board-basic-search-keyword"
    ...
    <b-card no-body class="mb-0">
      ...
      >
        ...
        <template #cell(cateCd)="data">
          {{ data.item.cateCd | eufGetCodeName(codes.CATE) }}
        </template>
