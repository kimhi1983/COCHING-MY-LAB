<template>
  <!--real-content-->
  <div class="real-content" id="coching-board-view">
    <div class="container-inner">
      ...
      <div class="board-view">
        ...
        <div class="board-view-content">
          ...
          <div class="text-box">
            <p>
              {{boardData.content}} <!-- 데이터 저장 시 p태그 감싸기 -->
            </p>
          </div>
          ...
          <BoardComment
            ...
            :boardWriter="boardData.writer"
            :boardWriterSeq="boardData.writerSeq"
            :boardCmtCnt="boardData.cmtCnt"></BoardComment>
        </div>
...
export default {
  name: 'coching-board-notice-view',
