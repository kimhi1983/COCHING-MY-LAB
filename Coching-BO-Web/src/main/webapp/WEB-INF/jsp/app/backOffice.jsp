...
<html lang="en">
  <head>
    <meta charset="utf-8" />
	<title>Coching-BackOffice</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="width=device-width,initial-scale=1.0,maximum-scale=1" />
    <link rel="shortcut icon" href="/favicon.png" type="image/x-icon">

  <link href="/css/app.css?dc3714ed887fe516f080" rel="stylesheet"></head>
  <body>
    <noscript>
      <strong>
        We're sorry but 
        Coching-BackOffice doesn't work properly without JavaScript enabled. 
  ...
  <script src="/js/app.js?dc3714ed887fe516f080"></script></body>    
