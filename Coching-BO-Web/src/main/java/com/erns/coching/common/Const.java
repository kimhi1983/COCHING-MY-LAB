...
public class Const {
    ...
    public static final String APP_PREFIX = "CHBW"; //BPSP BackOfiice Web
    ...
    public static final String ES_COCHING_RAW_INACTIVE_INDEX_SYSKEY = "es.search.inactive.raw.index";
    public static final String ES_COCHING_RAW_INDEX_PREFIX_SYSKEY = "es.search.active.raw.index.prefix";

    public static final String ES_COCHING_TV_ACTIVE_INDEX_SYSKEY = "es.search.active.tv.index";
    public static final String ES_COCHING_TV_INACTIVE_INDEX_SYSKEY = "es.search.inactive.tv.index";
    public static final String ES_COCHING_TV_INDEX_PREFIX_SYSKEY = "es.search.active.tv.index.prefix";
