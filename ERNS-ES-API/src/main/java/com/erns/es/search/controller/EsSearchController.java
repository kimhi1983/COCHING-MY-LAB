...
import com.erns.es.search.service.EsSearchService;
...
public class EsSearchController extends AbstractApiController {

	private final EsSearchService searchService;

	@Autowired
	public EsSearchController(EsSearchService searchService) {
